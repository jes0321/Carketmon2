...
void Stage::Render(HDC _hdc)
{
	...
	else if (m_stageType == StageType::Boss)
		_texName = L"Mark_Boss";
	else if (m_stageType == StageType::Exchange)
		_texName = L"Mark_Exchange";
	else if (m_stageType == StageType::TreatmentCenter)
		_texName = L"Mark_TreatmentCenter";
